...
const shortsGalleryData = [
  {
    ...
    url: "https://www.youtube.com/watch?v=Q595t3wpnU8",
    thumbnail:
      "https://img.youtube.com/vi/Q595t3wpnU8/maxresdefault.jpg",
    duration: "0:45",
    level: "Beginner",
    calories: "150 cal",
  },
  {
    ...
    thumbnail:
      "https://img.youtube.com/vi/EUxQpQMnpa8/maxresdefault.jpg",
    duration: "1:15",
    level: "Intermediate",
    calories: "200 cal",
  },
    ...
    <div id="home" className="w-full overflow-x-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <section className="hero-section relative overflow-hidden rounded-3xl border border-white/20 mt-6 bg-gradient-to-br from-gray-900 via-black to-red-900/20">
          ...
          <div className="relative pt-28 pb-40 md:pt-32 md:pb-32 text-center">
            <motion.div
            ...
            >
              ...
              >
                ...
                & up to{" "}
                <span className="font-bold text-green-400">60% OFF</span>.
              </motion.p>
            ...
            {[
              ...
              >
                ...
                <div className="relative p-8">
                  <div
                    className={`inline-flex p-3 rounded-xl bg-gradient-to-r ${gradient} shadow-lg`}
                  >
                  ...
                  <div className="flex items-center gap-2 mt-6 text-sm text-neutral-400 group-hover:text-red-400 transition-colors">
        ...
        <section className="py-16 md:py-20 bg-gradient-to-br from-gray-900 to-black rounded-3xl">
          ...
          >
            ...
            <p className="section-subtitle text-center mt-4 max-w-2xl mx-auto text-base sm:text-lg px-4">
              See what our members have achieved with our proven training
              methods
            </p>
          </motion.div>
          ...
          >
            <div className="flex items-center justify-center gap-4 flex-wrap">
              ...
              <p className="text-white text-lg font-semibold">
                Get <span className="text-2xl">60% OFF</span> on Yearly
                Membership + <span className="underline">FREE</span> Personal
                Training Sessions!
              </p>
              <motion.a
                href="#contact"
        ...
        {/* Keep the rest of your existing sections (Trainers, Gallery, Contact, etc.) but apply similar enhancements */}
        ...
        <section id="trainers" className="py-20 md:py-28">
          <div className="text-center">
            ...
            <p className="section-subtitle text-center mt-4 max-w-2xl mx-auto text-lg">
              Certified professionals with decades of combined experience to
        ...
        >
          ...
          {/* Combined Gallery Tabs */}
          <div className="mt-12">
            <div className="flex justify-center mb-8">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-1 border border-white/10">
                <button className="px-6 py-3 rounded-xl bg-blue-500 text-white font-semibold transition-all duration-300">
                  Photos & Videos
                </button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {/* Fixed galleryData structure */}
              {galleryData.map((item, idx) => (
                <div
                  key={idx}
                  className={`group relative overflow-hidden rounded-2xl border border-white/10 hover:border-blue-500 transition-all duration-500 ${
          ...
          <div className="mt-16 max-w-4xl mx-auto">
            ...
            <div className="mt-16 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-3xl p-8 text-center">
              ...
              <p className="text-indigo-100 mb-6 max-w-2xl mx-auto">
                Our team is here to help you get all the answers you need to
        ...
        >
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <p className="section-subtitle mt-4 text-base sm:text-lg">
                Ready to change your life? Contact us now for your free trial
